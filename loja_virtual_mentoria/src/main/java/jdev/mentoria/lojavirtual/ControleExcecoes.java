...
import jdev.mentoria.lojavirtual.service.ServiceEnvioEmail;
...
public class ControleExcecoes extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers,
		...
		ex.printStackTrace();
		try {
			serviceEnvioEmail.enviarEmailHtml("Erro na loja virtual", ExceptionUtils.getStackTrace(ex), "leandrobatista192@gmail.com");
